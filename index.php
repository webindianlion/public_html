...
<body class="home">
    ...
    <section class="container whyWebsite py-5">
        <h3 class="ttl text-primary">Why your business need a website?</h3>
    ...
    <section class="container my-5">
        <h3 class="ttl text-primary"> Strategy We use to Buid Website </h3>
    ...
    <div class="b-example-divider"></div>
    <section class="container py-5">
        <h3 class="ttl text-primary"> 6999 INR Only </h3>
        <p class="subTtl"> Simply Contact Us To Know More </p>
        <div class="row pt-3">
            <div class="cardd col" data-aos="fade-up">
                <p> AMP Enabled </p>
            ...
            <div class="cardd col" data-aos="fade-up">
                <p> Social Profiles Creations </p>
            </div>
            <div class="cardd col" data-aos="fade-up">
                <p> 5 Official Emails </p>
            </div>
            <div class="cardd col" data-aos="fade-up">
                <p> Logo + Favicon </p>
            </div>

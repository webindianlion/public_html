...
<body class="home">
    ...
    <section class="container whyWebsite py-5">
        <h3 class="ttl text-primary">Why does your business need a website?</h3>
        <p class="subTtl">Let us give more space to your business to expand via the internet with the website wings.</p>
        <div class="row pt-3">
            <div class="col-12">
                ...
                <div class="col-md-6 mb-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="fw-normal"> inWebService support our customers whenever they need us. </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 mb-3">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="text-primary"> Experienced </h4>
                            <p class="fw-normal"> inWebService have many years of experience to move their customers upto their goels.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 mb-3">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="text-primary"> Quality Assurance </h4>
                            <p class="fw-normal"> inWebService ensures you to provide standard quality of services.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 mb-3">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="text-primary"> Reliable </h4>
                            <p class="fw-normal"> We will get our fruits after you. </p>
                        </div>
                    </div>
                </div>
            </div>

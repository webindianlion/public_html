...
class Ajax_pagination{
    ...
    function create_links(){
        ...
        // SHOWING LINKS  commented by ROOP
        /*if ($this->show_count){
        ...
        // Render the "First" link commented by ROOP
    ...
    function getAJAXlink($count, $text) {
        ...
        return '<a  '.$this->anchor_class .' class="searchFilter" style="cursor: pointer;color:#fff" id="'.$pageCount.'" >'. $text .'</a>';
       //class="searchFilter" id="'.$pageCount.'"' . href="javascript:void(0);" $this->anchor_class . ' 
    }
}
